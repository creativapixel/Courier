		...
		public function setPageFormat($format, $orientation='P') {
			...
			if (is_string($format)) {
				...
				switch (strtoupper($format)) {
					...
					case 'OFICIO': {$format = array(609.449,935.5); break;}	
//					case 'ETIQUETA1': {$format = array(297.549,849.90); break;}	
					case 'ETIQUETA1': {$format = array(297.638,850.394); break;}
					case 'ETIQUETA2': {$format = array(226.772,793.701); break;}						
				}
				$this->fwPt = $format[0];
				$this->fhPt = $format[1];
			} else {
