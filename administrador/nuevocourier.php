  ...
  <tr>
	...
	<form name="form1"  id="form1">
	  <table width="356" border="0" align="center" cellpadding="0">
          ...
          <tr>
            <td width="70" align="center" class="color_celda">Courier</td>
            <td width="14" align="center" class="color_celda">:</td>
            <td width="264" align="left" valign="top" class="enfasis"><input name="courier" type="text" id="courier" size="40"  onkeyup='fn(this.form,this)' ></td>
          </tr>
          <tr>
            <td align="center" class="color_celda">Ciudad</td>
            <td align="center" class="color_celda">:</td>
            <td align="left" valign="top" class="enfasis"><?php  	
					$auxiliares->generar_select_ciudad('ciudad','',''); ?></td>
          </tr>
          <tr>
      ...
      <table width="356" border="0" align="center" cellpadding="0">
        <tr>
          <td colspan="3" align="center">
            ...
            <input name="enviar" type="button" class="btn" onClick="nuevo();" value="Grabar Courier">
            &nbsp;&nbsp;
            <label>
...
function nuevo()
{
	...
	if (document.forms.form1.courier.value=="")
	{ 
		document.forms.form1.courier.focus();
		alert("Ingresar Courier");
		return false; 
	}

document.forms.form1.action='nuevocourier.php';
