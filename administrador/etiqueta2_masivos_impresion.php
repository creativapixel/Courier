...
$pdf = new TCPDF('P', 'cm', 'ETIQUETA2', true);  
...
//set margins 
$pdf->SetMargins(0.5, 0, 0.5); //izq, arriba, derecha
//$pdf->SetHeaderMargin(PDF_MARGIN_HEADER); 

//$pdf->SetFooterMargin(PDF_MARGON_FOOTER); 
...
$destinatario=strtoupper($campo['cmas_destinatario']);
$direccion=strtoupper($campo['cmas_direccion'].' '.$campo['cmas_caserio']);
$ciudad=strtoupper($campo['cmas_ciudad']);


$pdf->Cell(7,0.2,"",0,0,'C');
$pdf->Ln();
$pdf->Cell(7,0.7,"".$destinatario."",0,0,'C');	
$pdf->Ln();
$pdf->Cell(7,0.7,"".$direccion."",0,0,'C');	
$pdf->Ln();
$pdf->Cell(7,0.6,"".$ciudad."",0,0,'C');	
$pdf->Ln();
$pdf->Cell(7,0.2,"",0,0,'C');	
$pdf->Ln();
