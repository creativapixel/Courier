      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
        ...
        <tr>
          <td colspan="6" align="center"><h5>
            <img src="../archivos/titulo_buscarresumencc.png" width="382" height="36" />
            <input name="id" type="hidden" id="id" />
          </h5></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td width="123" align="center" class="color_celda">Nro. de Resumen  : </td>
          <td width="166"><input name="nro" type="text" id="nro" value="<?php echo $_REQUEST['nro'];?>" /></td>
          <td width="169" colspan="-2" align="center"><input name="Submit" type="button" class="btn" value="Buscar Resumen" onclick="listar_cargos()"/></td>
          <td width="286">&nbsp;</td>
          <td width="197">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="6" align="center"><table width="950" border="0">
            ...
            <tr bgcolor="#FFFFFF" style="cursor: hand" onMouseOver="bgColor='#FFDBB7'" onMouseOut ="bgColor='#FFFFFF'">
              ...
              <td width="6%" align="center"><a href="#" onclick="vista_previa_guia(<?php echo $campo['carcou_id'];?>)"><?php echo $campo['carcou_centrocosto'];  ?></a></td>
...
function listar_cargos(){
	document.forms.form1.action='buscar_resumencentrocosto.php';
