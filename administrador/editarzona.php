...
if (isset($_REQUEST['zona_id']))
	{ 	
		$_SESSION['zona_codigo']=$_REQUEST['zona_id'];		
		
 	}

if ($_REQUEST['id']==='1')
 	{
		$auxiliares->zona_editar($_SESSION['zona_codigo'],$_REQUEST['descripcion'],$_REQUEST['precio']);
    }

$auxiliares->zona_ver($_SESSION['zona_codigo']);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><h5>EDITAR ZONA</h5></td>
  </tr>
	...
	<form id="form1" name="form1" method="post" action="">
	  ...
	  <table width="488" border="0" align="center" cellpadding="0" cellspacing="2">
        ...
        <tr align="left">
          ...
          <td width="390"><input name="descripcion" type="text" id="descripcion" value="<?php  echo $auxiliares->zon_descripcion; ?>" size="40" />
            <input name="id" type="hidden" id="id" /></td>
        </tr>
        <tr align="left">
          <td class="color_celda" >Precio (S/.) </td>
          <td align="center" class="color_celda" >:</td>
          <td><input name="precio" type="text" id="precio" value="<?php  echo $auxiliares->zon_precio; ?>" /></td>
        </tr>
        <tr align="left">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
function editar()
{
	...
	document.forms.form1.id.value='1'
  	document.forms.form1.action='editarzona.php';
