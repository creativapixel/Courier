  ...
  <tr>
	...
	<form name="form1"  id="form1">
	  <table width="356" border="0" align="center" cellpadding="0">
          ...
          <tr>
            <td width="70" align="center" class="color_celda">Area</td>
            <td width="14" align="center" class="color_celda">:</td>
            <td width="264" align="center" valign="top" class="enfasis"><input name="area" type="text" id="area" size="40"  onkeyup='fn(this.form,this)' ></td>
          </tr>
          <tr>
      ...
      <table width="356" border="0" align="center" cellpadding="0">
        <tr>
          <td colspan="3" align="center">
            ...
            <input name="enviar" type="button" class="btn" onClick="nuevo();" value="Grabar Area">
            &nbsp;&nbsp;
            <label>
...
function nuevo()
{
	...
	if (document.forms.form1.area.value=="")
	{ 
...
document.forms.form1.action='nuevaarea.php';
