...
$nombre = date("d-m-y")."_bdcargos_courier.txt";
...
<table width='400' border='0' cellspacing='0' cellpadding='0' class='color_celda' align='center'>
	<tr>
		<td>
			&nbsp;
		</td>
	...
	<tr>
		<td>
			<strong><font size='4' face='Arial, Helvetica, sans-serif'>Backup de seguridad de base de datos</font></strong>
		</td>
	</tr>
	<tr>
		<td>
			<table width='400' border='0' cellspacing='0' cellpadding='0'>
				<tr>
					<td>
						...
						Para realizar una copia de seguridad de sus datos, hacer un clic en el boton Generar respaldo de la base de datos y posteriormente guardar en una unidad del disco duro.
						</font>
					</td>
				</tr>
				...
				<tr>
					<td>
						<font size='2' face='Arial, Helvetica, sans-serif'><input type='submit' name='Submit' value='Generar respaldo de la base de datos' class='btn' ><input name='cerrar' type='button' class='btn' onClick='window.close();' value='Cerrar Ventana'></font>
					</td>
				</tr>
			</table>
		</td>
