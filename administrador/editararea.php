...
if ($_REQUEST['id']==='1')
 	{
		$auxiliares->area_editar($_SESSION['area_codigo'],$_REQUEST['descripcion']);
    }

$auxiliares->area_ver($_SESSION['area_codigo']);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><h5>EDITAR AREA </h5></td>
  </tr>
	...
	<form id="form1" name="form1" method="post" action="">
	  ...
	  <table width="488" border="0" align="center" cellpadding="0" cellspacing="2">
        ...
        <tr align="left">
          ...
          <td width="390"><input name="descripcion" type="text" id="descripcion" value="<?php  echo $auxiliares->area_descripcion; ?>" size="40" />
...
function editar()
{
	...
	{ 
	 ...
	 alert("Ingrese Nombre de la Area");
	 return false; 
	}
