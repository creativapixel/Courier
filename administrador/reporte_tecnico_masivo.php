...
<table width="719" border="0" align="center">
  <tr>
    <td colspan="5"><img src="../archivos/titulo_reportetecnicomasivo.png" /></td>
    </tr>
...
<table width="950" border="0" align="center">
      <tr align="center">
        <td align="left" class="color_celda">Empresa</td>
        ...
        <td colspan="2" align="left">Del <span class="textoblanco"><?php echo $_REQUEST['fecha'];  ?></span> al <span class="textoblanco"><?php echo $_REQUEST['fecha2'];  ?></span></td>
        <td colspan="2" align="right"><span class="enfasis">
          <input name="Submit4" type="button" class="btn" value="Generar Reporte" onclick="vista_previa()"/>
        </span></td>
    </tr>
            ...
            <table width="950" border="0">
			 ...
			 $j=1;
              ...
              <tr bgcolor="#FFFFFF" style="cursor: hand" onmouseover="bgColor='#FFDBB7'" onmouseout ="bgColor='#FFFFFF'">
                <td width="53" align="center"><?php echo $campo['cmas_id'];  ?></td>
                <td width="49" align="center"><?php echo $cargo->util->obtienefecha($campo['cmas_fecha']);  ?></td>
                <td width="49" align="center"><?php echo strtoupper($campo['ze_descripcion']); ?></td>
                <td width="316" align="center"><?php echo strtoupper($campo['cmas_destinatario']); ?></td>
                <td width="226" align="center"><?php echo strtoupper($campo['cmas_direccion']); ?> <?php echo strtoupper($campo['cmas_caserio']); ?></td>
                <td width="112" align="center"><?php echo strtoupper($campo['ub_descripcion']);  ?></td>
...
function vista_previa(){
	window.open("reporte_masivos_tecnico.php?empresa_remite=<?php echo $_REQUEST['empresa_remite'];?>&fecha=<?php echo $_REQUEST['fecha'];?>&fecha2=<?php echo $_REQUEST['fecha2'];?>&estado=<?php echo $_REQUEST['estado'];?>&reporte=4", "_blank", "resizable,height=600,width=800");
}

function ver_datos()
{

document.forms.form1.action='reporte_tecnico_masivo.php';
