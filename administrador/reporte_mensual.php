      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
        ...
        <tr>
          <td colspan="6" align="center"><h5>
            <img src="../archivos/titulo_reportemensual.png" width="382" height="36" />
        ...
        <tr>
          <td>&nbsp;</td>
          <td width="107" align="center" class="color_celda">Empresa Remite : </td>
          <td width="368"><?php  $empresas->generar_select_empresa_todos('empresa_remite','',''); ?></td>
          <td width="74" colspan="-2" align="center" class="color_celda">Fecha Emis.:</td>
          <td width="276">
		  
		  <input name="fecha" type="text" id="fecha" value="<?php echo $_REQUEST['fecha']; ?>" size="8"   />
		...
		<input name="fechaf" type="text" id="fechaf" value="<?php echo $_REQUEST['fechaf']; ?>" size="8"/>
          ...
          <td width="130"><input name="Submit" type="button" class="btn" value="Generar Reporte" onclick="listar_cargos()"/></td>
        </tr>
        <tr>
          <td colspan="6" align="center"><table width="950" border="0">
            <tr align="center" class="fondonegro">
              <td width="8%">Fecha Emisi&oacute;n </td>
              <td width="7%">Zona</td>
            ...
            <tr bgcolor="#FFFFFF" style="cursor: hand" onMouseOver="bgColor='#FFDBB7'" onMouseOut ="bgColor='#FFFFFF'">
              ...
              <td width="6%" align="center"><?php echo $cargo->ver_incluyeigv($campo['carcou_incluyeigv']);?></td>
            </tr>
            <?php 
			  	$j=$j+1;
            ...
            <tr>
              ...
              <td class="enfasis">&nbsp;</td>
              <td colspan="10" class="enfasis"><input name="Submit2" type="button" class="btn" value="Imprimir Reporte (NO IGV)" onclick="vista_previa()"/>
               &nbsp;
                <input name="Submit3" type="submit" class="btn" value="Imprimir Reporte solo Totales (SI IGV)" onclick="vista_previa_totales()"/></td>
              </tr>
            <tr>
...
function listar_cargos(){
	document.forms.form1.action='reporte_mensual.php';
	document.forms.form1.method='post';
	document.forms.form1.submit();
}

function vista_previa(){
	window.open("reportemensual_impresion.php?empresa_remite=<?php echo $_REQUEST['empresa_remite'];?>&fecha=<?php echo $_REQUEST['fecha'];?>&fechaf=<?php echo $_REQUEST['fechaf'];?>", "_blank", "resizable,height=600,width=800");
}

function vista_previa_totales(){
	window.open("reportemensual_impresion_totales.php?empresa_remite=<?php echo $_REQUEST['empresa_remite'];?>&fecha=<?php echo $_REQUEST['fecha'];?>&fechaf=<?php echo $_REQUEST['fechaf'];?>", "_blank", "resizable,height=600,width=800");
}
