...
if (isset($_REQUEST['embalaje_id']))
	{ 	
		$_SESSION['embalaje_codigo']=$_REQUEST['embalaje_id'];		
		
 	}

if ($_REQUEST['id']==='1')
 	{
		$auxiliares->embalaje_editar($_SESSION['embalaje_codigo'],$_REQUEST['descripcion'],$_REQUEST['precio']);
    }

$auxiliares->embalaje_ver($_SESSION['embalaje_codigo']);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><h5>EDITAR EMBALAJE </h5></td>
  </tr>
	...
	<form id="form1" name="form1" method="post" action="">
	  ...
	  <table width="488" border="0" align="center" cellpadding="0" cellspacing="2">
        ...
        <tr align="left">
          ...
          <td width="390"><input name="descripcion" type="text" id="descripcion" value="<?php  echo $auxiliares->emb_descripcion; ?>" size="40" />
            <input name="id" type="hidden" id="id" /></td>
        </tr>
        <tr align="left">
          <td class="color_celda" >Precio (S/.) </td>
          <td align="center" class="color_celda" >:</td>
          <td><input name="precio" type="text" id="precio" value="<?php  echo $auxiliares->emb_precio; ?>" /></td>
        </tr>
        <tr align="left">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
function editar()
{
	...
	document.forms.form1.id.value='1'
  	document.forms.form1.action='editarembalaje.php';
